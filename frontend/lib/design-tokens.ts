 ...
 * - Teal/seafoam primary for trust and professionalism
 * - Soft green accents for growth and satisfaction
 * - Clean neutral palette for readability
 *
 * IMPORTANT: This file must stay in sync with:
 * - tailwind.config.ts (Tailwind uses these values)
 * - tokens/figma-tokens.json (Figma import/export)
 * - styles/globals.css (CSS custom properties)
 */

// ============================================================================
// Color Palette - Nature Theme (Teal Primary)
// ============================================================================

export const colors = {
  // Primary - Teal/Seafoam for CTAs and primary actions
  primary: {
    50: '#E5E9E2',
    100: '#C6E8AD',
    200: '#A3CE83',
    300: '#70A449',
    400: '#568530',
    500: '#389084', // Main primary - Nature teal
    600: '#296B62',
    700: '#264E46',
    800: '#233D28',
    900: '#0D2539',
  ...
  // Accent - Light green for highlights and positive indicators
  accent: {
    50: '#E6EBE2',
    100: '#FBFFF9',
    200: '#F8FFF3',
    300: '#F1FDE9',
    400: '#D7F2C3',
    500: '#C6E8AD', // Main accent - Soft green
    600: '#AED493',
    700: '#81B05F',
    800: '#618844',
    900: '#416229',
  ...
  // Neutral - Clean grays with subtle warmth
  neutral: {
    0: '#FFFFFF',
    50: '#FAFAFA',
    100: '#F4F4F5',
    200: '#E4E4E7',
    300: '#D4D4D8',
    400: '#98A691', // Slight green tint
    500: '#71717A',
    600: '#52525B',
    700: '#264E46', // Teal-tinted dark
    800: '#264E46',
    900: '#18181B',
    950: '#09090B',
  },
  ...
  csat: {
    ...
    4: '#AED493', // Satisfied - Light green (accent-600)
    5: '#389084', // Very Satisfied - Primary teal
  },
} as const;
...
export const shadows = {
  ...
  // Colored shadows for cards and elevated elements (using primary teal)
