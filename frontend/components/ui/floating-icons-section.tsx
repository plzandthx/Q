...
// Interface for the main section component's props.
export interface FloatingIconsSectionProps {
  title: string;
  subtitle: string;
  icons: IconProps[];
}
...
const Icon = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="flex items-center justify-center w-12 h-12 md:w-16 md:h-16 p-2 md:p-3 rounded-2xl shadow-lg bg-white/90 backdrop-blur-md border border-neutral-200/50"
        animate={{
          y: [0, -8, 0, 8, 0],
          x: [0, 6, 0, -6, 0],
          rotate: [0, 5, 0, -5, 0],
...
const FloatingIconsSection = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & FloatingIconsSectionProps
>(({ className, title, subtitle, icons, ...props }, ref) => {
  ...
  return (
    <section
      ...
      className={cn(
        'relative w-full min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-hidden bg-gradient-to-b from-white to-neutral-50',
        className
      )}
      {...props}
    >
